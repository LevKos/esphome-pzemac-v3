...
namespace esphome
{
  namespace mymodbus
  {
    ...
    class MyModbus : public uart::UARTDevice, public Component
    {
    public:
      MyModbus() = default;
      ...
      void register_device(MyModbusDevice *device) { this->devices_.push_back(device); }
    ...
    protected:
      ...
      std::vector<MyModbusDevice *> devices_;
    };

    class MyModbusDevice
    {
    public:
      void set_parent(MyModbus *parent) { parent_ = parent; }
      void set_address(uint8_t address) { address_ = address; }
      virtual void on_modbus_data(const std::vector<uint8_t> &data) = 0;
      virtual void on_modbus_error(uint8_t function_code, uint8_t exception_code) {}
      virtual void on_modbus_offline(void) override;
